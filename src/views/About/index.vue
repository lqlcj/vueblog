<template>
  <div class="wrapper">
    ...
    <div class="page-title">
      <p class="text-page-title">Privacy Statement</p>
    </div>

    <div class="text-page">
      <p class="title">MP3jam Privacy Policy</p>
      <p> This Privacy Policy covers the MP3jam software and the MP3jam website (<a href="/">www.mp3jam.org</a>).
      ...
      <p class="title">Collected Information</p>
      <p> The software and the website do not collect ANY personal information that helps to identify you as an
      ...
      <p class="title">Information Use</p>
      <p> The software and the website do not collect, sell, transfer, rent, lease, publish, disclose and distribute
